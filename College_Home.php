...
$email_check=mysqli_query($conn,"SELECT * FROM `collegeapply` WHERE `email`='$email'");
if(mysqli_num_rows($email_check)>0){
	...
	{
		header('location: std_dashbroadclg.php');
	}
}
...
<div class="jumbotron">
  <li class="txt"> <h1> College Online Admission </h1>
  
  <button class=" btn btn-lg btn-dark text-white active "><a  class="nav-link"href="registerformclg.php"<h1 class="ap">Apply Now new Student</h1></a></button>
  </li>
	...
	<div class="card-body ">
						...
						<form method="POST" action="">
							<div class="input-group justify-content-right ">
								...
								<input type="text"  name="email" class="form-control py-4" placeholder="Email or phone">
							...
							<br/>
							<div class="input-group ">
							<input  type="submit" class="btn btn-success btn-ms" value="Login" name="login" />
							</div>
							<br/>
							<br/>
