...
<div class="header">
		...
		<div class="container ">
			<div class="jumbotron">
					...
					<input type="text"  name ="school" placeholder="Enter student class name" />
	...
	if(isset($_POST['search'])){
		$school=$_POST['school'];
	$query=mysqli_query($conn,"SELECT * FROM `schoolapply` WHERE `school` ='$school'");
	...
	<div class="container-fluid text-info">
		<div class="row">
			...
			<a href="" class="list-group-item " ><i class="glyphicon glyphicon-user"></i> school Details
					</a>
  ...
  <table  id="table_id" class="table table-hover  table-striped">
	...
	while($row=mysqli_fetch_assoc($result)){
      ...
      <tr>
        ...
        <td><?php echo $row['date_time']; ?></td>
		<td>
		<a href ="deletesc.php?id=<?=$row['id'];?>" class="btn btn-xs btn-danger"><i></i>Delete   </a>
