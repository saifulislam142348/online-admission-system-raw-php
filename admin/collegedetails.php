...
<div class="header">
	...
	$query=mysqli_query($conn,"SELECT * FROM `collegeapply` WHERE `college_name` ='$college'");
	...
	?>
					...
					<input type="text"  name ="college" placeholder="Enter  Course name" />
					<input type="submit" name ="search" value="   search Course "/>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<a href="" class="list-group-item active" ><i class="glyphicon glyphicon-user"></i>college Details
					</a>
  ...
  <table  id="table_id"class="table  table-striped">
	...
	while($row=mysqli_fetch_assoc($result)){
      ...
      <tr>
        ...
        <td><?php echo $row['date_time']; ?></td>
		<td>
		<a href ="deleteclg.php?id=<?=base64_encode($row['id']);?>" class="btn btn-xs btn-danger"><i></i>Delete   </a>
